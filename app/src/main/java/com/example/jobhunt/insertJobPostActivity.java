...
public class insertJobPostActivity extends AppCompatActivity {
    ...
    private void InsertJob(){
        ...
        post_job_btn.setOnClickListener(v->{
            ...
            Data data=new Data(jobTitle9,jobDescription9,skillsRequired9,salary9,id,date);
            mJobPost.child(id).setValue(data);

            mPublicDatabase.child(id).setValue(data);
            Toast.makeText(insertJobPostActivity.this,"Successful",Toast.LENGTH_LONG).show();
